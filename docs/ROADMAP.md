...
| # | 항목 | 비고 |
|---|------|------|
| 1 | **후행스팬(Chikou)** | 종가 26봉 되돌림 표시 (선택) |
| 2 | **Finnhub 시세** | Yahoo 유지 중 — 필요 시 전환 검토 |
| 3 | **모바일 UX** | 팝업·차트 터치·뷰포트 |
| 4 | **관측/알림** | API 실패율, DART 한도 대시 |
| 5 | **커스텀 도메인** | 보류 (Vercel DNS) |
| 6 | **수익화** | 로그인, 유료 데이터 — 요구사항 확정 후 |
